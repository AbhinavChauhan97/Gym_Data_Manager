...
import com.abhinav.chauhan.practice.Dialogs.DatePickerDialog;
    ...
    private void setClickImageImageButton(View view) {
        ...
        mClickImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imageFileUri = FileProvider.getUriForFile(getActivity(), "com.abhinav.chauhan.practice.provider", file);
